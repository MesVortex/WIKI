      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="https://flowbite.com" class="flex ms-2 md:me-24">
            <img src="<?php echo URLROOT ?>/img/logo.png" class="h-8" alt="FlowBite Logo" />
            ...
            <div class="flex items-center ms-3">
              <div>
                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                  ...
                  <img class="w-8 h-8 rounded-full" src="<?php echo URLROOT?>/img/blue-user-icon-of-profile-and-account-vector-42404464.jpg" alt="user photo">
                </button>
              </div>
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow " id="dropdown-user">
                ...
                <ul class="py-1" role="none">
                  ...
                  <li>
                    <a href="<?php echo URLROOT?>/userController/signOut" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 " role="menuitem">Sign out</a>
                  </li>
                </ul>
              </div>
            </div>
...
<section class="flex gap-20 flex-wrap p-4 sm:ml-80 mt-14">
  <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
    ...
    <p class="mb-3 font-normal text-gray-500 ">Wiki's audience accounted for over <span class=" font-bold text-blue-700">5</span> monthly active users worldwide</p>
